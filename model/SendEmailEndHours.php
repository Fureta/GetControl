...
include "../lib/Reporte/mailfinhoras.php";
...
foreach($array as $DATOS) {
    ...
    $horascontratadas=$header[0]["HORASCONTRATADAS"];
    $horasconsumidas=$header[0]["TOTALHORAS"];

    
    if($contrato=="PLAN" && $horascontratadas<=$horasconsumidas)
    {
