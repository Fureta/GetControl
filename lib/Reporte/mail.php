...
function getMail($header)
{
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
          ...
          .h1, .h2, .bodycopy, .bodyfoo{color: #153643; font-family: sans-serif;}
          .col425 {width: 425px!important;}
          .innerpadding {padding: 30px 30px 30px 30px;}
          .borderbottom {border-bottom: 1px solid #f2eeed;}
          .h2 {padding: 0 0 15px 0; font-size: 24px; line-height: 28px; font-weight: bold;}
          .bodycopy {font-size: 16px; line-height: 22px;}
          .bodyfoo {font-size: 12px; line-height: 22px;}
                  ...
                  <td>
                      ...
                      <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                          <tr>
                              ...
                              <a href="https://findcontrol.info"><img src="https://findcontrol.info/wp-content/uploads/2020/04/Findcontrol.png" width="200" height=auto border="0" alt="" / >  
                              </a>
                              </td>
                          </tr>
                          <tr>
                      ...
                      foreach($header as $header)
                      {
                        $plantilla.='
                          ...
                          Horas restantes: '.$header["RESTANTES"].'<br><br>
    ...
    <tr>
      <td style="padding: 20px 0 0 0;">
        <table class="buttonwrapper" style="border-radius:10px" bgcolor="#00a1e0" align="center" border="0" cellspacing="0" cellpadding="0">
          <tr>
    ...
    <tr>
      <td style="padding: 20px 0 0 0;">
        <table class="buttonwrapper" bgcolor="#00a1e0" align="center" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="button" height="45">
              <a href="https://www.findcontrol.info/GetControl">Ingresar a GetControl</a>
            </td>
          </tr>
        </table>
      </td>
