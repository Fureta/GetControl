                    ...
                    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td class="innerpadding borderbottom">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="h2">
                                            Recordatorio fin de plan contratado.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="bodycopy">
                                            El área de Administracion de FindControl se pondrá en contacto con ustedes.
                                        </td>
                                    </tr>
                                </table>
                            </td>
                      ...
                      foreach($header as $header)
                      {
                        $plantilla.='
                          ...
                          Su plan finaliza el dia '.$header["FECHAFIN"].'<br>
                        ';
                      }
                      $plantilla.='</td>
                      </tr>
                                ...
                                <tr>
                                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                                        <a href="http://www.facebook.com/">
                                            <img src="https://img.icons8.com/color/48/000000/linkedin-2--v1.png" width="37" height="37" alt="Facebook" border="0"  />
                                        </a>
                                    </td>
                                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                                        <a href="http://www.twitter.com/">
                                            <img src="https://findcontrol.info/wp-content/uploads/2020/08/Get-Control_Logo_lock.jpg" width="37" height="37" alt="Twitter" border="0" style="border-radius:130px;"/>
                                        </a>
                                    </td>
                                </tr>
                            </table>
